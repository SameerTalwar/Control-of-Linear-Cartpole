...
%% Assembly
% Link to the 
% <matlab:system(fullfile(matlabroot,'toolbox/physmod/smlink/smlinkdemos/proe/robot','robot.asm')) assembly>
%
...
%
% This is a view of the robot arm assembly as modelled in Pro/ENGINEER(R).
% 
% <<robot_proe.jpg>>
% 
